...
const char* ssid = "Kevenny";         /* coloque aqui o nome da rede wi-fi que o ESP32 deve se conectar */
const char* password = "MainWarwick"; /* coloque aqui a senha da rede wi-fi que o ESP32 deve se conectar */
